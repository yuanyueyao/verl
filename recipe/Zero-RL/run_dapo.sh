...
# Zero-RL: DAPO（完整复现，含 Group Filtering / Dynamic Sampling）
# Qwen3-4B-Base @ 4 GPU (0-3)
...
# DAPO Dynamic Sampling: 生成 3 倍 prompt，只保留组内 reward 方差异 0 的
...
LOG_FILE="${LOG_DIR}/dapo_${TIMESTAMP}.log"
CKPTS_DIR="/data3/yyy/verl/checkpoints/zero_rl/${exp_name}"

echo "========================================================="
echo " Zero-RL: DAPO (full: filter_groups + decoupled clip)"
echo "   模型: ${MODEL_PATH}"
echo "   数据: ${TRAIN_FILE}"
