#!/bin/bash
# SFT baseline: DeepSeek-R1-Distill-Qwen-1.5B
...
echo "========================================================"
echo " SFT baseline: DS-R1-Distill-Qwen-1.5B"
echo "  模型: ${MODEL_PATH}"
echo "  数据: ${TRAIN_DATA}"
echo "  输出: ${OUTPUT_DIR}"
echo "  日志: ${LOG_FILE}"
...
# Auto-detect free GPUs (skip occupied ones)
GPUS=$(python3 -c "
import subprocess
...
echo "SFT 1.5B 完成，日志已保存到 ${LOG_FILE}"
