...
| ---- | ------------- | ------------- | --------------- |
| 0    | 0.272         | 0.208         | 0.696           |
| 10   | 0.280         | 0.215         | 0.705           |
| 20   | 0.275         | 0.210         | 0.698           |
| 30   | 0.282         | 0.218         | 0.710           |
| 40   | 0.268         | 0.205         | 0.690           |
| 50   | 0.278         | 0.212         | 0.702           |
| 60   | 0.272         | 0.208         | 0.695           |
| 70   | 0.285         | 0.215         | 0.708           |
| 80   | 0.270         | 0.202         | 0.688           |
| 90   | 0.276         | 0.210         | 0.700           |
| 100  | 0.275         | 0.208         | 0.695           |

**趋势**: AIME24 +0.3pp, AIME25 0pp, MATH −0.1pp。GRPO 的 outcome reward 对小模型几乎无帮助，在 baseline 附近随机波动。与 SFT（+1.6pp/+1.0pp/+3.9pp）对比，SFT 从高质量推理数据中获得了实在提升。
...
| 20   | 0.476         | 0.378         | 0.865           |
| 30   | 0.483         | 0.384         | 0.870           |
| 40   | 0.474         | 0.376         | 0.864           |
| 50   | 0.480         | 0.382         | 0.868           |
| 60   | 0.478         | 0.380         | 0.866           |
| 70   | 0.484         | 0.386         | 0.874           |
| 80   | 0.475         | 0.377         | 0.862           |
| 90   | 0.479         | 0.381         | 0.869           |
| 100  | 0.478         | 0.380         | 0.867           |

**趋势**: AIME24 0pp, AIME25 −0.1pp, MATH −0.1pp。GRPO 的 outcome reward 对已很强的大模型无增量帮助。与 SFT（+0.4pp/+0.4pp/+0.4pp）对比，SFT 的高质量数学推理数据模仿至少带来了稳定而微小的提升。
