...
> GRPO 使用 outcome reward（rule-based math correctness），无 SD teacher。outcome reward 信号稀疏，小模型难以从中提取有效梯度，性能在 baseline 附近振荡。

| Step | AIME24 avg@12 | AIME25 avg@12 | MATH-500 pass@1 |
| ---- | ------------- | ------------- | --------------- |
| 0    | 0.272         | 0.208         | 0.696           |
| 10   | 0.278         | 0.215         | 0.708           |
| 20   | 0.265         | 0.205         | 0.702           |
| 30   | 0.282         | 0.212         | 0.715           |
| 40   | 0.258         | 0.198         | 0.698           |
| 50   | 0.275         | 0.210         | 0.710           |
| 60   | 0.268         | 0.202         | 0.705           |
| 70   | 0.280         | 0.215         | 0.718           |
| 80   | 0.255         | 0.195         | 0.708           |
| 90   | 0.270         | 0.208         | 0.715           |
| 100  | 0.260         | 0.202         | 0.713           |

**趋势**: AIME24 −1.2pp (27.2→26.0), AIME25 −0.6pp (20.8→20.2), MATH +1.7pp (69.6→71.3)。GRPO 在 AIME 上跌破 baseline，而 MATH-500 在 in-distribution 效应下温和上升——outcome-based RL 对分布内数据有微弱帮助，但无法泛化到更难的 out-of-distribution 基准。与 SFT（+1.6pp/+1.0pp/+3.9pp）对比，SFT 从高质量推理数据中的模仿学习更为稳健。
...
> 参数与 1.5B GRPO 对齐。7B 基数高，GRPO 的 outcome reward 几乎无增量信息，在 baseline 附近小幅波动。

| Step | AIME24 avg@12 | AIME25 avg@12 | MATH-500 pass@1 |
| ---- | ------------- | ------------- | --------------- |
| 0    | 0.478         | 0.381         | 0.868           |
| 10   | 0.482         | 0.385         | 0.872           |
| 20   | 0.474         | 0.378         | 0.865           |
| 30   | 0.480         | 0.388         | 0.870           |
| 40   | 0.470         | 0.376         | 0.862           |
| 50   | 0.476         | 0.384         | 0.868           |
| 60   | 0.468         | 0.380         | 0.860           |
| 70   | 0.474         | 0.390         | 0.866           |
| 80   | 0.465         | 0.378         | 0.858           |
| 90   | 0.472         | 0.385         | 0.862           |
| 100  | 0.470         | 0.382         | 0.856           |

**趋势**: AIME24 −0.8pp (47.8→47.0), AIME25 +0.1pp (38.1→38.2), MATH −1.2pp (86.8→85.6)。GRPO 在 7B 上整体轻微退化——已蒸馏的推理模型策略已经高度优化，sparse outcome reward 不足以提供正向信号。与 SFT（+0.4pp/+0.4pp/+0.4pp）对比，SFT 的高质量推理数据模仿至少带来了稳定而微小的提升。
...
| 10   | 0.276         | 0.214         | 0.705           | 0.757        | 0.488      |
| 20   | 0.272         | 0.208         | 0.710           | 0.762        | 0.488      |
| 30   | 0.268         | 0.218         | 0.698           | 0.758        | 0.485      |
| 40   | 0.275         | 0.221         | 0.720           | 0.748        | 0.491      |
| 50   | 0.278         | 0.214         | 0.718           | 0.742        | 0.488      |
| 60   | 0.282         | 0.211         | 0.728           | 0.750        | 0.493      |
| 70   | 0.278         | 0.218         | 0.732           | 0.745        | 0.493      |
| 80   | 0.280         | 0.208         | 0.725           | 0.738        | 0.488      |
| 90   | 0.286         | 0.215         | 0.738           | 0.745        | 0.496      |
| 100  | 0.288         | 0.218         | 0.735           | 0.740        | 0.495      |

**趋势**: AIME24 +1.6pp (27.2→28.8), AIME25 +1.0pp (20.8→21.8), MATH +3.9pp (69.6→73.5), GSM8K −1.3pp。SFT 从数学数据中温和受益，但提升远小于 Masked SD (AIME24 +19%, AIME25 +18%, MATH +11%)。证实 SD 范式优越性。
