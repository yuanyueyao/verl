...
grpo_15b = {
    "aime24": np.array([0.272, 0.280, 0.275, 0.282, 0.268, 0.278, 0.272, 0.285, 0.270, 0.276, 0.275]),
    "aime25": np.array([0.208, 0.215, 0.210, 0.218, 0.205, 0.212, 0.208, 0.215, 0.202, 0.210, 0.208]),
    "math500": np.array([0.696, 0.705, 0.698, 0.710, 0.690, 0.702, 0.695, 0.708, 0.688, 0.700, 0.695]),
}
...
grpo_7b = {
    "aime24": np.array([0.478, 0.482, 0.476, 0.483, 0.474, 0.480, 0.478, 0.484, 0.475, 0.479, 0.478]),
    "aime25": np.array([0.381, 0.385, 0.378, 0.384, 0.376, 0.382, 0.380, 0.386, 0.377, 0.381, 0.380]),
    "math500": np.array([0.868, 0.872, 0.865, 0.870, 0.864, 0.868, 0.866, 0.874, 0.862, 0.869, 0.867]),
}
