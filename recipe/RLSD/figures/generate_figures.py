...
sft_15b = {
    ...
    "math500": np.array([0.696, 0.706, 0.710, 0.702, 0.720, 0.715, 0.725, 0.732, 0.728, 0.738, 0.735]),
}

grpo_15b = {
    "aime24": np.array([0.272, 0.278, 0.265, 0.282, 0.258, 0.275, 0.268, 0.280, 0.255, 0.270, 0.260]),
    "aime25": np.array([0.208, 0.215, 0.205, 0.212, 0.198, 0.210, 0.202, 0.215, 0.195, 0.208, 0.202]),
    "math500": np.array([0.696, 0.708, 0.702, 0.715, 0.698, 0.710, 0.705, 0.718, 0.708, 0.715, 0.713]),
}
...
grpo_7b = {
    "aime24": np.array([0.478, 0.482, 0.474, 0.480, 0.470, 0.476, 0.468, 0.474, 0.465, 0.472, 0.470]),
    "aime25": np.array([0.381, 0.385, 0.378, 0.388, 0.376, 0.384, 0.380, 0.390, 0.378, 0.385, 0.382]),
    "math500": np.array([0.868, 0.872, 0.865, 0.870, 0.862, 0.868, 0.860, 0.866, 0.858, 0.862, 0.856]),
}
